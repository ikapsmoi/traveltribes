  ...
  return (
    <div className="bg-brand-white py-16 md:py-24 px-6 md:px-16">
      <div className="max-w-4xl mx-auto">
          ...
          {faqs.map((faq) => (
            ...
            >
              ...
              <button
                ...
                className="w-full px-6 py-6 text-left flex items-center justify-between hover:bg-brand-light transition-colors duration-300"
              >
                <span className="font-body font-semibold text-lg text-text-primary pr-4">
                  {faq.question}
                </span>
                <div className="flex-shrink-0">
                  {openFAQ === faq.id ? (
                    <Minus className="w-5 h-5 text-brand-aqua" />
                  ) : (
        ...
        {/* Bottom CTA Section */}
        <div className="mt-16 text-center bg-brand-light rounded-xl p-8 md:p-12">
