  ...
  return (
    <div className="bg-brand-light py-16 md:py-24 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit) => {
            ...
            return (
              <div
                key={benefit.id}
                className="group bg-brand-white border border-ui-border rounded-xl p-8 hover:shadow-card transition-all duration-300 hover:-translate-y-1"
              >
                {/* Icon */}
                <div
                  className={`${colors.bg} ${colors.text} ${colors.hover} rounded-lg p-4 w-16 h-16 flex items-center justify-center mb-6 transition-all duration-300`}
                >
                  {benefit.icon}
                </div>
        ...
        <div className="mt-20 bg-brand-white rounded-xl border border-ui-border p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="font-display font-bold text-3xl md:text-4xl text-brand-aqua mb-2">
                10,000+
              </div>
              <p className="font-body text-text-secondary">Happy Travelers</p>
            </div>
            <div className="text-center">
              <div className="font-display font-bold text-3xl md:text-4xl text-brand-navy mb-2">
                500+
              </div>
              <p className="font-body text-text-secondary">Expert Hosts</p>
            </div>
            <div className="text-center">
              <div className="font-display font-bold text-3xl md:text-4xl text-brand-forest mb-2">
                85
              </div>
              <p className="font-body text-text-secondary">Countries</p>
            </div>
            <div className="text-center">
              <div className="font-display font-bold text-3xl md:text-4xl text-brand-navy/80 mb-2">
                2,500+
              </div>
              <p className="font-body text-text-secondary">Trips Completed</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          <button className="bg-brand-aqua hover:bg-brand-aqua/90 text-brand-white font-body font-semibold px-10 py-4 rounded-button transition-all duration-300 text-lg">
            Get Started Now
          </button>
        </div>
      </div>
